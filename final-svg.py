...
def finalLine(ps, root, p1i, p2i, delay):
    ...
    l = ET.Element("{http://www.w3.org/2000/svg}line", x1=p1[0], y1=p1[1], x2=p2[0], y2=p2[1], style="stroke-width:3;stroke-linecap:round;stroke-linejoin:round")
    r.append(l)
...
def main(solfn):
    ...
    #     deactivate(i, time)
    outfn = sys.argv[1].replace('-solution.json', '-img.svg')
